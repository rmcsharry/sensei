...
4. `chmod +x start.sh`
5. `./start.sh --name projectName --openai-key OPENAI-API-KEY --session-secret SESSION-SECRET`
...
1. `chmod +x branch.sh`
2. `./branch.sh --name branchName --openai-key OPENAI-API-KEY --session-secret SESSION-SECRET`
